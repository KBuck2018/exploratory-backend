...
* The original package name 'com.exploratory-backend.exploratory-backend' is invalid and this project uses 'com.exploratorybackend.exploratorybackend' instead.
